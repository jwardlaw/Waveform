                ...
                if (specialTargetProperty)
                {
                    ...
                    switch (targetProperty.ToLower())
                    {
                        ...
                        case "color":
                            ...
                            break;
                        case "tcolor":
                            targetMaterials = gameObject.transform.GetComponent<TrailRenderer>().GetComponent<Renderer>().materials;
                            for(int i = 0; i < gameObject.transform.GetComponent<TrailRenderer>().GetComponent<Renderer>().materials.Length; i++)
                            {
                                clampedValue = Mathf.Clamp(propertyValue, 0.0f, 1.0f);
                                newColor = new Color(clampedValue,
                                                     clampedValue,
